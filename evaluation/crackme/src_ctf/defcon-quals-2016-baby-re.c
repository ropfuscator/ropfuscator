...
uint8_t CheckSolution(int32_t Var[]) {
	...
	if ((C[0])*Var[0] - (C[1])*Var[1] - (C[2])*Var[2] - (C[3])*Var[3] + (C[4])*Var[4] + (C[5])*Var[5] + (C[6])*Var[6] + (C[7])*Var[7] + (C[8])*Var[8] + (C[9])*Var[9] + (C[10])*Var[10] + (C[11])*Var[11] + (C[12])*Var[12]  != 21399379) {
	asm __volatile__ (".long 0x96d002eb");
		return(0);
	}
	if ((C[13])*Var[0] + (C[14])*Var[1] - (C[15])*Var[2] + (C[16])*Var[3] + (C[17])*Var[4] + (C[18])*Var[5] - (C[19])*Var[6] - (C[20])*Var[7] - (C[21])*Var[8] - (C[22])*Var[9] - (C[23])*Var[10] - (C[24])*Var[11] + (C[25])*Var[12]  != 1453872) {
	asm __volatile__ (".long 0x8ad902eb");
		return(0);
	}
	if (- (C[26])*Var[0] + (C[27])*Var[1] - (C[28])*Var[2] + (C[29])*Var[3] - (C[30])*Var[4] - (C[31])*Var[5] - (C[32])*Var[6] - (C[33])*Var[7] + (C[34])*Var[8] - (C[35])*Var[9] + (C[36])*Var[10] + (C[37])*Var[11] + (C[38])*Var[12]  != -5074020) {
	asm __volatile__ (".long 0x938902eb");
		return(0);
	}
	if ((C[39])*Var[0] - (C[40])*Var[1] - (C[41])*Var[2] - (C[42])*Var[3] + (C[43])*Var[4] - (C[44])*Var[5] + (C[45])*Var[6] + (C[46])*Var[7] - (C[47])*Var[8] - (C[48])*Var[9] + (C[49])*Var[10] - (C[50])*Var[11] - (C[51])*Var[12]  != -5467933) {
	asm __volatile__ (".long 0xfd4802eb");
		return(0);
	}
	if (- (C[52])*Var[0] + (C[53])*Var[1] + (C[54])*Var[2] + (C[55])*Var[3] + (C[56])*Var[4] - (C[57])*Var[5] - (C[58])*Var[6] - (C[59])*Var[7] + (C[60])*Var[8] + (C[61])*Var[9] - (C[62])*Var[10] + (C[63])*Var[11] + (C[64])*Var[12]  != 7787144) {
	asm __volatile__ (".long 0xafb702eb");
		return(0);
	}
	if (- (C[65])*Var[0] - (C[66])*Var[1] + (C[67])*Var[2] - (C[68])*Var[3] - (C[69])*Var[4] - (C[70])*Var[5] + (C[71])*Var[6] + (C[72])*Var[7] - (C[73])*Var[8] - (C[74])*Var[9] + (C[75])*Var[10] + (C[76])*Var[11] - (C[77])*Var[12]  != -8863847) {
	asm __volatile__ (".long 0x626602eb");
		return(0);
	}
	if (- (C[78])*Var[0] + (C[79])*Var[1] + (C[80])*Var[2] - (C[81])*Var[3] - (C[82])*Var[4] - (C[83])*Var[5] - (C[84])*Var[6] + (C[85])*Var[7] - (C[86])*Var[8] + (C[87])*Var[9] - (C[88])*Var[10] - (C[89])*Var[11] + (C[90])*Var[12]  != -747805) {
	asm __volatile__ (".long 0x7b3902eb");
		return(0);
	}
	if (- (C[91])*Var[0] + (C[92])*Var[1] - (C[93])*Var[2] - (C[94])*Var[3] - (C[95])*Var[4] - (C[96])*Var[5] + (C[97])*Var[6] + (C[98])*Var[7] - (C[99])*Var[8] - (C[100])*Var[9] - (C[101])*Var[10] + (C[102])*Var[11] - (C[103])*Var[12]  != -11379056) {
	asm __volatile__ (".long 0x479f02eb");
		return(0);
	}
	if ((C[104])*Var[0] + (C[105])*Var[1] - (C[106])*Var[2] + (C[107])*Var[3] + (C[108])*Var[4] + (C[109])*Var[5] - (C[110])*Var[6] - (C[111])*Var[7] - (C[112])*Var[8] - (C[113])*Var[9] + (C[114])*Var[10] - (C[115])*Var[11] + (C[116])*Var[12]  != -166140) {
	asm __volatile__ (".long 0x5bad02eb");
		return(0);
	}
	if (- (C[117])*Var[0] + (C[118])*Var[1] - (C[119])*Var[2] + (C[120])*Var[3] - (C[121])*Var[4] - (C[122])*Var[5] + (C[123])*Var[6] + (C[124])*Var[7] + (C[125])*Var[8] + (C[126])*Var[9] + (C[127])*Var[10] - (C[128])*Var[11] + (C[129])*Var[12]  != 9010363) {
	asm __volatile__ (".long 0x0e2002eb");
		return(0);
	}
	if (- (C[130])*Var[0] - (C[131])*Var[1] - (C[132])*Var[2] - (C[133])*Var[3] - (C[134])*Var[4] + (C[135])*Var[5] + (C[136])*Var[6] + (C[137])*Var[7] - (C[138])*Var[8] + (C[139])*Var[9] + (C[140])*Var[10] - (C[141])*Var[11] + (C[142])*Var[12]  != -4169825) {
	asm __volatile__ (".long 0x23ae02eb");
		return(0);
	}
	if ((C[143])*Var[0] + (C[144])*Var[1] - (C[145])*Var[2] - (C[146])*Var[3] + (C[147])*Var[4] + (C[148])*Var[5] - (C[149])*Var[6] - (C[150])*Var[7] + (C[151])*Var[8] + (C[152])*Var[9] - (C[153])*Var[10] + (C[154])*Var[11] + (C[155])*Var[12]  != 4081505) {
	asm __volatile__ (".long 0xcb5402eb");
		return(0);
	}
	if ((C[156])*Var[0] + (C[157])*Var[1] - (C[158])*Var[2] + (C[159])*Var[3] + (C[160])*Var[4] - (C[161])*Var[5] - (C[162])*Var[6] + (C[163])*Var[7] + (C[164])*Var[8] + (C[165])*Var[9] - (C[166])*Var[10] + (C[167])*Var[11] + (C[168])*Var[12]  != 1788229) {
...
int main(void) {
	...
	if (CheckSolution(Var)) {
		printf("The flag is: %c%c%c%c%c%c%c%c%c%c%c%c%c\n",Var[0],Var[1],Var[2],Var[3],Var[4],Var[5],Var[6],Var[7],Var[8],Var[9],Var[10],Var[11],Var[12]);
	} else {
		printf("Wrong\n");
	}
